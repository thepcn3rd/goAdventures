...
The purpose of this page is to share my notes on setting up kali VM after installation from Kali 2024.2 ISO.
...
```bash
sudo apt install openssl jupyter-notebook remmina mingw-w64 golang software-properties-common apt-transport-https
```
