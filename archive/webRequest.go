...
// GOOS=linux GOARCH=amd64 go build -o webRequest.bin -ldflags "-w -s" webRequest.go
...
func defaultConf() *requestConf {
	d := requestConf{}
	d.reqMethod = "get"
	d.reqURL = "http://127.0.0.1:8000"
	d.reqOutput = "false" // Displayed on the screen
