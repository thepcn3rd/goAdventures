...
go env -w GOPATH="/home/thepcn3rd/go/workspaces/v2fake"
...
// Compile for donut to run as shellcode
GOOS=windows GOARCH=amd64 go build -buildmode=pie -o v2fakeAsm.exe -ldflags "-w -s" main.go
...
func Executeprogram() {
	...
	cf.CreateDirectory(directorySlash + "information" + directorySlash)
	cf.CreateDirectory(directorySlash + "information" + directorySlash + "archive" + directorySlash)
	cf.CreateDirectory(directorySlash + "information" + directorySlash + "archive2000" + directorySlash)
	cf.CreateDirectory(directorySlash + "information" + directorySlash + "archive2010" + directorySlash)
